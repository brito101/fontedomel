...
add_filter('woocommerce_checkout_fields', 'brito_custom_checkout');
...
// Adiciona Campo
// function brito_custom_checkout_field($checkout)
// {
...
// }
// add_action('woocommerce_after_order_notes', 'brito_custom_checkout_field');

// Validar Campo
// function brito_custom_checkout_field_process()
// {
//   if (!$_POST['mensagem_personalizada']) {
//     wc_add_notice('Por favor, escreva uma mensagem personalizada.', 'error');
//   }
// }
// add_action('woocommerce_checkout_process', 'brito_custom_checkout_field_process');

// // Adicionar ao Banco de Dados
// function brito_custom_checkout_field_update($order_id)
// {
...
//   }
// }
// add_action('woocommerce_checkout_update_order_meta', 'brito_custom_checkout_field_update');
